...
public class PickUpInteractionContext
{
    ...
    public PickUpInteractionContext(TwoBoneIKConstraint rightIkConstraint,
        ...
        Rigidbody rigidbody, CapsuleCollider rootCollider, Transform rootTransform)
    {
        ...
        CharacterShoulderHeight = rightIkConstraint.data.root.transform.position.y;
