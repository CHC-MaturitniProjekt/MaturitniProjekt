...
public class PickedUpState : PickUpInteractionState
{
    ...
    public PickedUpState(PickUpInteractionContext context, PickUpInteractionStateMachine.EPickUpInteractionState estate) : base(context, estate)
    {
