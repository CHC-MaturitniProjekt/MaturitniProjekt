...
public abstract class PickUpInteractionState : BaseState<PickUpInteractionStateMachine.EPickUpInteractionState>
{
    protected PickUpInteractionContext Context;
    private float _movingAwayOffset = 0.2f;
    private bool _shouldReset;
    
    public PickUpInteractionState(PickUpInteractionContext context, PickUpInteractionStateMachine.EPickUpInteractionState stateKey) : base(stateKey)
    {
        Context = context;
    }
    ...
    protected void UpdateIkTargetPosition(Collider intersectingCollider)
    {
        ...
        Vector3 shoulderDirection = Context.CurrentBodySide == PickUpInteractionContext.EBodySide.RIGHT
        ...
        bool currentSide;
        if (Context.CurrentBodySide == PickUpInteractionContext.EBodySide.RIGHT)                                   //upravit
        {
